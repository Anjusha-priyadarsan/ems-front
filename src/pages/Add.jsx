  ...
  return (
    <>
        ...
        <div className='container mt-5'>
          ...
          <h1 className='text-center fw-bold text-light' >Add New Employee Details</h1>
          ...
          <div className='mt-3 shadow border rounded p-2'>
            ...
            <div className='text-center mt-5'>
              ...
              <img style={{ width: "70px", height: "70px", borderRadius: "50%" }} src={preview?preview:"https://img.freepik.com/premium-vector/man-avatar-profile-picture-vector-illustration_268834-538.jpg" } alt="" />
